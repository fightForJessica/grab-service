...
class MainViewModel() : ViewModel() {
    ...
    fun prepareAppInfos(context: Context) {
        _appInfoLoadStatus.value = AppInfoLoadStatus.LOADING
        runCatching {
            ...
            _appInfoLoadStatus.value = AppInfoLoadStatus.SUCCESS
            appInfoList.clear()
            appInfoList.addAll(appInfos)
        }.onFailure {
            _appInfoLoadStatus.value = AppInfoLoadStatus.FAILURE
        }
    }
